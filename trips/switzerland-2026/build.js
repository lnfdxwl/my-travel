...
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .money { background:linear-gradient(135deg,#f3f8fd 0%,#fdf8ef 100%); border:1px solid #dfe8f2;
    border-radius:10px; padding:16px 20px; margin:4px 0 16px; }
  .mrow { display:flex; flex-wrap:wrap; align-items:baseline; gap:10px; padding:7px 0; }
  .mrow + .mrow { border-top:1px dashed #dfe2e6; }
  .mtag { background:#2563a8; color:#fff; font-size:12px; font-weight:600; padding:3px 11px; border-radius:4px; white-space:nowrap; }
  .mtag.alt { background:#27916a; }
  .mnum { font-size:19px; font-weight:700; color:#2c3e50; white-space:nowrap; }
  .mnum em { font-size:12px; font-weight:400; color:#888; font-style:normal; }
  .mcny { font-size:19px; font-weight:700; color:#c0392b; white-space:nowrap; }
  .mdesc { font-size:12.5px; color:#666; flex:1 1 260px; min-width:0; }
  @media (max-width:700px){ .mnum,.mcny{font-size:17px;} }
...
<section>
  ...
  <div class="money">
    <div class="mrow"><span class="mtag">按推荐方案</span>
      <span class="mnum">CHF 425–755 <em>/ 人</em></span>
      <span class="mcny">≈ ￥3,600–6,300</span>
      <span class="mdesc">10 天全部餐费，含 3 顿认真吃的（采尔马特芝士火锅 · 卢塞恩百年老店午市 · 苏黎世瑞士第一牛排）</span></div>
    <div class="mrow"><span class="mtag alt">一天只吃一顿正餐</span>
      <span class="mnum">CHF 370–500 <em>/ 人</em></span>
      <span class="mcny">≈ ￥3,100–4,200</span>
      <span class="mdesc">其余走超市三明治、自助餐厅、平价简餐 —— 瑞士本地人的日常吃法，不寒酸</span></div>
    <div class="note" style="margin-top:8px">均为每人 10 天餐费，不含酒水（酒水另计 CHF 80–150 ≈ ￥670–1,260）。按 <strong>1 CHF ≈ 8.4 元</strong>换算，汇率以出行前实时为准。</div>
  </div>
